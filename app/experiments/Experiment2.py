...
class Experiment2(Experiment):
    def __init__(self, args, csplib_desc_dir_path="data/output/generated_descriptions"):
        super().__init__(args)
        self.csplib_desc_dir_path = csplib_desc_dir_path
        self.output_dir = f"{args.output_dir}/exp2"
    ...
    def run(self):
        ...
        for index_level in INDICES_EXP:
            ...
            result_path = f"{self.output_dir}/index_{index_level}.txt"
        ...
        # Save all results
        self.save_results(results, f"{self.output_dir}/exp2.txt")
        return results
